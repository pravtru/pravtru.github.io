...
| Файл | Name | Описание |
|---|---|---|
| `Mdl1.xml` | Mdl1 | Пример модуля с двумя листами: `<svg tip="A3">` (border A3, горизонтальный) и `<svg tip="A4">` (border A4, вертикальный) |
...
Полный список (136 файлов) сгруппирован по разделам справочника УГО (условные графические обозначения, ЕСКД) — та же группировка используется в каталоге `Blok.htm`.
